...
$("#searchbtn").on("click", function (e) {
    ...
    $.get("localhost:3000/api" + searchedBand, function (data) {
        ...
        if (!data) {
            ...
            $("#well-section").append("<h3>Role: " + data.artistMembers + "</h3>");

            $("#well-section").append("<h3>Age: " + data.artistLocation + "</h3>");

            $("#well-section").append("<h3>Force Points: " + data.artistContactName + "</h3>");
        }
    });
});
